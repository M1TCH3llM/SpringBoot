...
public class EmployeeController {
	...
	public ModelAndView saveEmployee(@Validated Employee e,  BindingResult br) {
		...
		System.out.println("e.getAddress(): "+e.getAddress().getCity());
		System.out.println("e.getAddress(): "+e.getAddress().getState());
		System.out.println("e.getAddress(): "+e.getAddress().getCountry());
